...
class AccessoryCard (val key: String, val completed: Boolean, val accessoryArrayList: ArrayList<AccessoryExerciseObject>) : Item<ViewHolder>(){
    override fun bind(viewHolder: ViewHolder, position: Int) {
        ...
        accessoryArrayList.forEach {
            accessoryCardAdapter.add(AccessoryExerciseRow(key, completed, it))
        }
